...
def _write_markdown_report(results, output_path):
    ...
    lines.append("| ID | Tools Correct | Citations | Freshness | Hallucination Failure | Used Tools |")
    lines.append("|---|---|---|---|---|---|")
    ...
    for result in results:
        ...
        lines.append(
            ...
            f"{result['freshness_correctness']} | {result['hallucination_failure']} | {used_tool_text} |"
        )
